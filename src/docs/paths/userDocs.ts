...
export const userPaths = {
  "/users/profile": {
    ...
    put: {
      ...
      description:
        "Permite actualizar el nombre, teléfono, email o la foto de perfil usando formato multipart/form-data.",
      tags: ["Usuarios"],
      security: [{ bearerAuth: [] }],
      requestBody: {
        required: true,
            ...
            schema: {
              ...
              properties: {
                ...
                phone: {
                  ...
                  description: "Mínimo 6 caracteres o null",
                },
                email: {
                  type: "string",
                  format: "email",
                  example: "fleris@vianesso.com",
                },
                avatar: {
                  type: "string",
                  format: "binary",
                  description:
                    "Archivo de imagen para el avatar (JPEG, PNG, etc.)",
                },
              },
            },
          },
