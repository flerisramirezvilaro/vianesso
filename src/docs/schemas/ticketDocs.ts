...
export const ticketSchemas = {
  TicketStatus: {
    ...
    description:
      "Estados posibles en el flujo del ciclo de vida de un ticket de soporte técnico.",
    example: TicketStatus.PENDING_REVIEW,
  },
  CompactTicket: {
    type: "object",
    description:
      "Estructura optimizada y formateada en camelCase de un ticket para el cliente en el Frontend.",
    properties: {
      id: {
        type: "string",
        format: "uuid",
      ...
      technicianId: {
        ...
        description:
          "ID único del técnico asignado. Puede ser nulo si el ticket no ha sido tomado.",
      },
    },
  },
};
