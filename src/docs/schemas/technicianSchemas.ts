export const technicianSchemas = {
  TechnicianProfile: {
    type: "object",
    description:
      "Estructura detallada del perfil de un técnico de soporte técnico.",
    properties: {
      userId: {
        type: "string",
        format: "uuid",
      ...
      isAvailable: {
        ...
        example: true,
        description:
          "Indica si el técnico se encuentra disponible para aceptar nuevos tickets.",
      },
    },
  },
  AcceptedRequestResponse: {
    type: "object",
    description:
      "Estructura de respuesta exitosa al momento de aceptar y asignarse un ticket.",
    properties: {
      requestId: {
        type: "string",
        format: "uuid",
